...
async function deployExchangeFixture() {
    ...
    const token0 = await Token.deploy("Bitcoin", "BTC", "1000000")
    const token1 = await Token.deploy("Mock USDC", "mUSDC", "1000000")

    // Get accounts
    const accounts = await ethers.getSigners()
    const deployer = accounts[0] // Fee account
